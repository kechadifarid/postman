...
class AllureReporter {
  ...
  onBeforeItem(err, args) {
    ...
    this.currentTest = this.allureRuntime.startTest({
      ...
      labels: [(0, _reporter.getLanguageLabel)(), (0, _reporter.getFrameworkLabel)("newman"), hostLabel, threadLabel, (0, _reporter.getFallbackTestCaseIdLabel)((0, _reporter.md5)(legacyFullName)), ...labels, ...(0, _reporter.getEnvironmentLabels)()],
      links
    });
